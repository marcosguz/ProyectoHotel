 ...
 */
@Entity
@Table(name = "caracteristicahabitacion")
@NamedQueries({
...
public class Caracteristicahabitacion implements Serializable {
    ...
    public Caracteristicahabitacion(String id) {
        this.id = id;
    }
    ...
    public String toString() {
        return "ec.edu.itq.lenguajeprogramacion2.modelo.Caracteristicahabitacion[ id=" + id + " ]";
    }
